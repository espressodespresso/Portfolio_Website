...
export default function Home(): JSXElement {
    return (
        <>
            <section id="about_me">
                <div class="flex-col pt-24 text-center">
                    <img class="rounded-full w-52 border-2 border-solid border-slate-600 m-auto hover:scale-110 transition-transform" src={img}
                         alt="avatar"/>
                    <br/>
            ...
            <section class="bg-[#93f673]" id="featured">
                <div class="flex-col text-center">
                    <h1 class="text-2xl font-bold">Featured Projects</h1>
                    <p class="text-sm font-light italic accent-slate-800">Check out the Github Links!</p>
            ...
            <section class="bg-[#024b00] pb-10" id="experience">
                <div class="flex-col text-center">
                    <h1 class="text-2xl font-extrabold text-gray-50">Regarding Experience</h1>
                    <p class="text-sm font-light text-gray-200 italic">Generalised over 5+ Years</p>
            ...
            <section class="bg-[#092100]" id="contact_me">
                <div class="flex-col text-center">
                    <h1 class="text-2xl font-extrabold text-gray-100">Contact Me!</h1>
                    <p class="text-sm font-light text-gray-300 italic">Click below...</p>
                    <br/>
                    <a href="mailto:harry.martel@hotmail.com" type="button" class="inline-block ease-in-out
                     ...
                     border-solid rounded-xl border-2 font-bold text-sm pl-10 pr-10 pt-4 pb-4">
                        Contact
                    </a>
                    <br/>
                    <br/>
